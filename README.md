...
* [Awesome ML for Cybersecurity](https://github.com/jivoi/awesome-ml-for-cybersecurity) ⭐ 9,291 | 🐛 33 | 📅 2024-08-19 - Established resource for traditional ML approaches in security, predating modern LLM era.
* [Awesome AI Security](https://github.com/ottosulin/awesome-ai-security) ⭐ 1,398 | 🐛 139 | 📅 2026-08-16 - Complementary list focusing on AI security rather than AI for security applications.
* [Awesome-MCP-Security](https://github.com/Puliczek/awesome-mcp-security) ⭐ 729 | 🐛 162 | 📅 2026-03-03 - Definitive resource covering all aspects of Model Context Protocol security.
...
* [VLoc Bench](https://github.com/cisco-foundation-ai/vulnerability-localization-benchmark) ⭐ 18 | 🐛 6 | 🌐 Python | 📅 2026-07-21 - Two-phase agentic benchmark (500 tasks, 290 repos, 147 CWE types) evaluating terminal-based vulnerability localization and patch verification.
...
* [Counterfit](https://github.com/Azure/counterfit) ⭐ 935 | 🐛 25 | 🌐 Python | 📅 2025-07-18 - Automation layer for comprehensive ML system security assessment across multiple attack vectors.
...
* [promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 24,317 | 🐛 512 | 🌐 TypeScript | 📅 2026-08-17 - Open-source LLM red teaming tool for finding and fixing vulnerabilities. 100+ attack types, 250k+ users.
* [garak](https://github.com/leondz/garak/) ⭐ 8,836 | 🐛 390 | 🌐 Python | 📅 2026-08-14 - Specialized security probing tool designed specifically for LLM vulnerability assessment.
* [MCP-Scan](https://github.com/invariantlabs-ai/mcp-scan) ⭐ 2,915 | 🐛 9 | 🌐 Python | 📅 2026-08-17 - Security scanning tool specifically designed for Model Context Protocol servers.
...
* [HackingBuddyGPT](https://github.com/ipa-lab/hackingBuddyGPT) ⭐ 1,210 | 🐛 8 | 🌐 Python | 📅 2026-08-11 - Autonomous pentesting agent with corresponding benchmark dataset for standardized evaluation.
* [Agentic Radar](https://github.com/splx-ai/agentic-radar) ⭐ 1,036 | 🐛 15 | 🌐 Python | 📅 2025-11-27 - Open-source CLI security scanner for agentic workflows with automated detection.
* [Cynative](https://github.com/cynative/cynative) ⭐ 190 | 🐛 16 | 🌐 Go | 📅 2026-08-17 - Agentic security CLI that runs code in a built-in sandbox to research AWS, GCP, Azure, Kubernetes, GitHub and GitLab. Read-only enforced by default.
...
* [OWASP Agent Memory Guard](https://github.com/OWASP/www-project-agent-memory-guard) ⭐ 125 | 🐛 14 | 🌐 Python | 📅 2026-08-16 - Official OWASP framework for detecting and preventing AI agent memory poisoning (OWASP ASI06). Scans agent memory stores for prompt injection payloads, memory manipulation patterns, and data exfiltration attempts.
* [rust-in-peace](https://github.com/scadastrangelove/rust-in-peace) ⭐ 14 | 🐛 0 | 🌐 Python | 📅 2026-08-17 - Agentic security-review harness for Rust projects that autonomously finds, triages, fuzz-verifies, reports, and patches unsafe/FFI memory bugs, panic-DoS, and deserialization-trust issues.

### Red Team Agents

* [agentic\_security](https://github.com/msoedov/agentic_security/) ⭐ 1,966 | 🐛 74 | 🌐 Python | 📅 2026-07-31 - LLM vulnerability scanner specializing in agentic systems and workflows.
...
* [Darkmoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 844 | 🐛 1 | 🌐 Python | 📅 2026-08-06 - Open source engine for autonomous AI penetration testing that orchestrates 80+ offensive tools through human readable Markdown playbooks and agentic reasoning over MCP, with a command and raw output evidence trail for every finding across web, cloud, Active Directory, Kubernetes and API.
* [HunterX](https://github.com/nullc0d30/HunterX) ⭐ 12 | 🐛 12 | 🌐 Python | 📅 2026-08-17 - Open source AI-assisted vulnerability discovery, validation, and proof engine for security testing and red-team workflows.
