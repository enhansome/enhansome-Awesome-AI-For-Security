...
* [Awesome ML for Cybersecurity](https://github.com/jivoi/awesome-ml-for-cybersecurity) ⭐ 9,391 | 🐛 31 | 📅 2024-08-19 - Established resource for traditional ML approaches in security, predating modern LLM era.
* [Awesome AI Security](https://github.com/ottosulin/awesome-ai-security) ⭐ 1,488 | 🐛 184 | 📅 2026-09-17 - Complementary list focusing on AI security rather than AI for security applications.
* [Awesome-MCP-Security](https://github.com/Puliczek/awesome-mcp-security) ⭐ 738 | 🐛 211 | 📅 2026-03-03 - Definitive resource covering all aspects of Model Context Protocol security.
...
* [VLoc Bench](https://github.com/cisco-foundation-ai/vulnerability-localization-benchmark) ⭐ 28 | 🐛 6 | 🌐 Python | 📅 2026-09-14 - Two-phase agentic benchmark (500 tasks, 290 repos, 147 CWE types) evaluating terminal-based vulnerability localization and patch verification.
...
* [NYU CTF Bench](https://github.com/NYU-LLM-CTF/NYU_CTF_Bench) ⭐ 174 | 🐛 4 | 🌐 Python | 📅 2025-09-22 - Dockerized CTF challenges repository enabling automated LLM agent interaction across categories.
...
* [Counterfit](https://github.com/Azure/counterfit) ⭐ 939 | 🐛 26 | 🌐 Python | 📅 2025-07-18 - Automation layer for comprehensive ML system security assessment across multiple attack vectors.
* [DeepFool](https://github.com/lts4/deepfool) ⭐ 362 | 🐛 5 | 🌐 Matlab | 📅 2020-03-31 - Simple yet accurate method for generating adversarial examples against deep neural networks.
...
* [promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 25,292 | 🐛 638 | 🌐 TypeScript | 📅 2026-09-19 - Open-source LLM red teaming tool for finding and fixing vulnerabilities. 100+ attack types, 250k+ users.
* [garak](https://github.com/leondz/garak/) ⭐ 9,304 | 🐛 450 | 🌐 Python | 📅 2026-09-16 - Specialized security probing tool designed specifically for LLM vulnerability assessment.
* [MCP-Scan](https://github.com/invariantlabs-ai/mcp-scan) ⭐ 3,070 | 🐛 13 | 🌐 Python | 📅 2026-09-19 - Security scanning tool specifically designed for Model Context Protocol servers.
...
* [Deep-pwning](https://github.com/cchio/deep-pwning) ⭐ 569 | 🐛 5 | 🌐 Python | 📅 2023-03-25 - Framework for assessing ML model robustness against adversarial attacks through systematic evaluation.
...
* [HackingBuddyGPT](https://github.com/ipa-lab/hackingBuddyGPT) ⭐ 1,244 | 🐛 2 | 🌐 Python | 📅 2026-09-13 - Autonomous pentesting agent with corresponding benchmark dataset for standardized evaluation.
* [Agentic Radar](https://github.com/splx-ai/agentic-radar) ⭐ 1,054 | 🐛 15 | 🌐 Python | 📅 2025-11-27 - Open-source CLI security scanner for agentic workflows with automated detection.
* [Cynative](https://github.com/cynative/cynative) ⭐ 202 | 🐛 20 | 🌐 Go | 📅 2026-09-18 - Agentic security CLI that runs code in a built-in sandbox to research AWS, GCP, Azure, Kubernetes, GitHub and GitLab. Read-only enforced by default.
* [OWASP Agent Memory Guard](https://github.com/OWASP/www-project-agent-memory-guard) ⭐ 179 | 🐛 26 | 🌐 Python | 📅 2026-09-19 - Official OWASP framework for detecting and preventing AI agent memory poisoning (OWASP ASI06). Scans agent memory stores for prompt injection payloads, memory manipulation patterns, and data exfiltration attempts.
...
* [rust-in-peace](https://github.com/scadastrangelove/rust-in-peace) ⭐ 20 | 🐛 0 | 🌐 Python | 📅 2026-09-08 - Agentic security-review harness for Rust projects that autonomously finds, triages, fuzz-verifies, reports, and patches unsafe/FFI memory bugs, panic-DoS, and deserialization-trust issues.

### Red Team Agents

* [agentic\_security](https://github.com/msoedov/agentic_security/) ⭐ 2,004 | 🐛 72 | 🌐 Python | 📅 2026-09-11 - LLM vulnerability scanner specializing in agentic systems and workflows.
* [HackGPT](https://github.com/NoDataFound/hackGPT) ⭐ 1,210 | 🐛 19 | 🌐 Jupyter Notebook | 📅 2026-08-12 - LLM-powered tool designed specifically for offensive security and ethical hacking.
* [Darkmoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 952 | 🐛 2 | 🌐 Python | 📅 2026-09-16 - Open source engine for autonomous AI penetration testing that orchestrates 80+ offensive tools through human readable Markdown playbooks and agentic reasoning over MCP, with a command and raw output evidence trail for every finding across web, cloud, Active Directory, Kubernetes and API.
