...
* [Awesome ML for Cybersecurity](https://github.com/jivoi/awesome-ml-for-cybersecurity) ⭐ 9,376 | 🐛 31 | 📅 2024-08-19 - Established resource for traditional ML approaches in security, predating modern LLM era.
* [Awesome AI Security](https://github.com/ottosulin/awesome-ai-security) ⭐ 1,464 | 🐛 174 | 📅 2026-09-11 - Complementary list focusing on AI security rather than AI for security applications.
* [Awesome-MCP-Security](https://github.com/Puliczek/awesome-mcp-security) ⭐ 734 | 🐛 203 | 📅 2026-03-03 - Definitive resource covering all aspects of Model Context Protocol security.
...
* [VLoc Bench](https://github.com/cisco-foundation-ai/vulnerability-localization-benchmark) ⭐ 22 | 🐛 6 | 🌐 Python | 📅 2026-09-11 - Two-phase agentic benchmark (500 tasks, 290 repos, 147 CWE types) evaluating terminal-based vulnerability localization and patch verification.
...
* [promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 25,049 | 🐛 651 | 🌐 TypeScript | 📅 2026-09-12 - Open-source LLM red teaming tool for finding and fixing vulnerabilities. 100+ attack types, 250k+ users.
* [garak](https://github.com/leondz/garak/) ⭐ 9,218 | 🐛 427 | 🌐 Python | 📅 2026-09-09 - Specialized security probing tool designed specifically for LLM vulnerability assessment.
* [MCP-Scan](https://github.com/invariantlabs-ai/mcp-scan) ⭐ 3,034 | 🐛 16 | 🌐 Python | 📅 2026-09-11 - Security scanning tool specifically designed for Model Context Protocol servers.
...
* [HackingBuddyGPT](https://github.com/ipa-lab/hackingBuddyGPT) ⭐ 1,238 | 🐛 5 | 🌐 Python | 📅 2026-08-29 - Autonomous pentesting agent with corresponding benchmark dataset for standardized evaluation.
* [Agentic Radar](https://github.com/splx-ai/agentic-radar) ⭐ 1,051 | 🐛 15 | 🌐 Python | 📅 2025-11-27 - Open-source CLI security scanner for agentic workflows with automated detection.
* [Cynative](https://github.com/cynative/cynative) ⭐ 200 | 🐛 20 | 🌐 Go | 📅 2026-09-12 - Agentic security CLI that runs code in a built-in sandbox to research AWS, GCP, Azure, Kubernetes, GitHub and GitLab. Read-only enforced by default.
* [OWASP Agent Memory Guard](https://github.com/OWASP/www-project-agent-memory-guard) ⭐ 173 | 🐛 22 | 🌐 Python | 📅 2026-09-12 - Official OWASP framework for detecting and preventing AI agent memory poisoning (OWASP ASI06). Scans agent memory stores for prompt injection payloads, memory manipulation patterns, and data exfiltration attempts.
...
* [agentic\_security](https://github.com/msoedov/agentic_security/) ⭐ 1,990 | 🐛 72 | 🌐 Python | 📅 2026-09-11 - LLM vulnerability scanner specializing in agentic systems and workflows.
* [HackGPT](https://github.com/NoDataFound/hackGPT) ⭐ 1,204 | 🐛 20 | 🌐 Jupyter Notebook | 📅 2026-08-12 - LLM-powered tool designed specifically for offensive security and ethical hacking.
* [Darkmoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 921 | 🐛 2 | 🌐 Python | 📅 2026-09-08 - Open source engine for autonomous AI penetration testing that orchestrates 80+ offensive tools through human readable Markdown playbooks and agentic reasoning over MCP, with a command and raw output evidence trail for every finding across web, cloud, Active Directory, Kubernetes and API.
