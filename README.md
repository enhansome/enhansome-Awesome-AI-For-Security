...
* [Awesome ML for Cybersecurity](https://github.com/jivoi/awesome-ml-for-cybersecurity) ⭐ 9,408 | 🐛 31 | 📅 2024-08-19 - Established resource for traditional ML approaches in security, predating modern LLM era.
* [Awesome AI Security](https://github.com/ottosulin/awesome-ai-security) ⭐ 1,497 | 🐛 195 | 📅 2026-09-24 - Complementary list focusing on AI security rather than AI for security applications.
* [Awesome-MCP-Security](https://github.com/Puliczek/awesome-mcp-security) ⭐ 737 | 🐛 215 | 📅 2026-03-03 - Definitive resource covering all aspects of Model Context Protocol security.
...
* [MCP-Security-Checklist](https://github.com/slowmist/MCP-Security-Checklist) ⭐ 831 | 🐛 9 | 📅 2025-04-28 - Comprehensive security checklist for MCP-based AI tools by SlowMist.
...
* [promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 25,461 | 🐛 643 | 🌐 TypeScript | 📅 2026-09-26 - Open-source LLM red teaming tool for finding and fixing vulnerabilities. 100+ attack types, 250k+ users.
* [garak](https://github.com/leondz/garak/) ⭐ 9,358 | 🐛 463 | 🌐 Python | 📅 2026-09-16 - Specialized security probing tool designed specifically for LLM vulnerability assessment.
* [MCP-Scan](https://github.com/invariantlabs-ai/mcp-scan) ⭐ 3,091 | 🐛 14 | 🌐 Python | 📅 2026-09-25 - Security scanning tool specifically designed for Model Context Protocol servers.
...
* [Cynative](https://github.com/cynative/cynative) ⭐ 208 | 🐛 20 | 🌐 Go | 📅 2026-09-25 - Agentic security CLI that runs code in a built-in sandbox to research AWS, GCP, Azure, Kubernetes, GitHub and GitLab. Read-only enforced by default.
* [OWASP Agent Memory Guard](https://github.com/OWASP/www-project-agent-memory-guard) ⭐ 184 | 🐛 26 | 🌐 Python | 📅 2026-09-25 - Official OWASP framework for detecting and preventing AI agent memory poisoning (OWASP ASI06). Scans agent memory stores for prompt injection payloads, memory manipulation patterns, and data exfiltration attempts.
...
* [Darkmoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 970 | 🐛 3 | 🌐 Python | 📅 2026-09-25 - Open source engine for autonomous AI penetration testing that orchestrates 80+ offensive tools through human readable Markdown playbooks and agentic reasoning over MCP, with a command and raw output evidence trail for every finding across web, cloud, Active Directory, Kubernetes and API.
